...
function setComaInitObjectInMainMap(){
  ...
  mainGameField.map.cell3d[1][7][7] = new hisha(1);
  mainGameField.map.cell3d[1][7][1] = new kaku(1);
  mainGameField.map.cell3d[7][7][1] = new hisha(1);
  mainGameField.map.cell3d[7][7][7] = new kaku(1);
